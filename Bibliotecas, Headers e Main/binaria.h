 ...
 * por raiz.
 */
NoArvBinaria *buscaArvBinRec(NoArvBinaria *raiz, unsigned long int k);
 ...
 * (*x)->chave == k
 */
NoArvBinaria **buscaEnderecoDoPonteiro(NoArvBinaria **raiz, unsigned long int k);
...
NoArvBinaria *insereArvBinIterativa(NoArvBinaria **raiz, unsigned long int k);
